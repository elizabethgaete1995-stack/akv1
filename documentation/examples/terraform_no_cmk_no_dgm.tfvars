## ESTE TFVARS COMPRUEBA LAS CONDICIONES. NO PERMITE NI CIFRADO NI TRUST CON SKU DISTINTO DE PREMIUM
// COMMON VARIABLES
...
network_rule_set = [
  {
    ...
    virtual_network = [
      {
      action = "Allow"
      subnet_id = "/subscriptions/ebac6c00-3c2f-4d56-82c0-8057225d44fa/resourceGroups/sgtd2weursgplatfoglob001/providers/Microsoft.Network/virtualNetworks/sgtd2weuvntplatfoglob001/subnets/sgtd2weuvntplatfoglob001-snt60"
      }
    ]
}]
