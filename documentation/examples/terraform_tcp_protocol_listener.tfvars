...
//PRODUCT
agw_name      = "sgtd2weuagwitdmodcomm576"
...
network_interfaces = ["nic-avm"] #As many as the number of backend_address_pools
...
backend_address_pools = [
  ...
  {
    name = "sgtd2weupfsitdmodcomm230125"
    fqdns = ["sgtd2weupfsitdmodcomm230125.postgres.database.azure.com"]
    ip = []
  }
]
frontend_port = ["80", "5433"]
...
#TCP Config
set_tcp_settings = true
backend_tcp_settings = [
  {
    name = "sgtd2weupfsitdmodcomm230125"
    port = 5432
...
tcp_listeners = [
  {
    name = "sgtd2weupfsitdmodcomm230125"
    frontend_ip_configuration_name = "vnetprereq-feip-private"
    frontend_port_name = "vnetprereq-feport_5433"
  }
]
tcp_routing_rules = [
  {
    name = "sgtd2weupfsitdmodcomm230125"
    tcp_listener_name = "sgtd2weupfsitdmodcomm230125"
    backend_address_pool_name = "sgtd2weupfsitdmodcomm230125"
    backend_tcp_settings_name = "sgtd2weupfsitdmodcomm230125"
    priority = 220
  }
] 
